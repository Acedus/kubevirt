...
func (VirtualMachineBackupStatus) SwaggerDoc() map[string]string {
	return map[string]string{
		...
		"fromCheckpoint":  "FromCheckpoint records which checkpoint was used as the incremental base.\n+optional",
	}
}

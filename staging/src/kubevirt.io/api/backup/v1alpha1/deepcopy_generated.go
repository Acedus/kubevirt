...
func (in *BackupOptions) DeepCopyInto(out *BackupOptions) {
	*out = *in
	...
	if in.ScratchPath != nil {
		in, out := &in.ScratchPath, &out.ScratchPath
		*out = new(string)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualMachineBackupEndpoint) DeepCopyInto(out *VirtualMachineBackupEndpoint) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualMachineBackupEndpoint.
func (in *VirtualMachineBackupEndpoint) DeepCopy() *VirtualMachineBackupEndpoint {
	if in == nil {
		return nil
	}
	out := new(VirtualMachineBackupEndpoint)
	in.DeepCopyInto(out)
	return out
}

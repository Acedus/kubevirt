...
func (admitter *VMBackupAdmitter) Admit(ctx context.Context, ar *admissionv1.AdmissionReview) *admissionv1.AdmissionResponse {
	...
	case admissionv1.Create:
		causes, err = admitter.validateSingalBackup(vmBackup, ar.Request.Namespace, causes)
		if err != nil {
			return webhookutils.ToAdmissionResponseError(err)
		}
...
func (admitter *VMBackupAdmitter) validateSingalBackup(vmBackup *backupv1.VirtualMachineBackup, namespace string, causes []metav1.StatusCause) ([]metav1.StatusCause, error) {

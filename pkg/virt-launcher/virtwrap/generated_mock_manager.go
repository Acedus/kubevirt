...
func (m *MockDomainManager) RedefineCheckpoint(arg0 *v1.VirtualMachineInstance, arg1 *v1alpha1.BackupCheckpoint, arg2 string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RedefineCheckpoint", arg0, arg1, arg2)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockDomainManagerMockRecorder) RedefineCheckpoint(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RedefineCheckpoint", reflect.TypeOf((*MockDomainManager)(nil).RedefineCheckpoint), arg0, arg1, arg2)
}

...
func (d *DomainConfigurator) Convert_v1_Disk_To_api_Disk(diskDevice *v1.Disk, disk *api.Disk, prefixMap map[string]deviceNamer, volumeStatusMap map[string]v1.VolumeStatus) error {
